...
export const folderService = {
  ...
  getFolders: (params?: FolderFilterParams) =>
    api.get<ApiResponse<PaginatedResponse<Folder>>>('/folders', { params }).then((res) => res.data),

  /**
   * GET /folders/detail?id=:id
   */
  getFolderById: (id: string) =>
    api.get<ApiResponse<Folder>>('/folders/detail', { params: { id } }).then((res) => res.data),
  ...
  createFolder: (payload: CreateFolderInput) =>
    api.post<ApiResponse<Folder>>('/folders/create', payload).then((res) => res.data),
   ...
   */
  deleteFolder: (id: string) => api.delete<ApiResponse>('/folders/delete', { params: { id } }).then((res) => res.data),
};
