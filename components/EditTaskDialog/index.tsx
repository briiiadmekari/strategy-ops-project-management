        ...
        <Controller
          ...
          render={({ field }) => (
            <CustomInput
              ...
              label="Status"
              value={field.value}
              onValueChange={(value) => field.onChange(value as z.infer<typeof updateTaskSchema>['status'])}
        ...
        <Controller
          ...
          render={({ field }) => (
            <CustomInput
              ...
              onValueChange={(value) =>
                field.onChange(value === 'none' ? undefined : (value as z.infer<typeof updateTaskSchema>['priority']))
              }
